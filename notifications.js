...
class NotificationManager extends EventEmitter {
  ...
  sendNotification(userId, notification, analyticsCallback) {
    const now = Date.now();
    ...
    // Google Analytics event (если передан analyticsCallback)
...
// Для интеграции GA из server.js
module.exports = Object.assign(notificationManager, {
  NotificationManager
});
